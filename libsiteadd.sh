...
m4_wrap() {
	...
	m4 -P -D "xSITE_NAME=$SITE_NAME" -D "xPHPDIR=$ETCPHPDIR" -D "xWWWDIR=$APACHEDIR" -D "xLOGDIR=$LOGDIR" -D "xPORT=$SITE_PORT" -D "xADDRESS=$BIND_ADDRESS" -D "xTIMEZONE=$TIMEZONE" -D "xCCSID=$CCSID" -D "xCHROOTPREFIX=$CHROOT_PREFIX" -D "xPHPVER=$PHP_VERSION" "$1" > "$2"
}
