...
m4_wrap() {
	...
	m4 -P -D "xSITE_NAME=$SITE_NAME" -D "xPHPDIR=$ETCPHPDIR" -D "xWWWDIR=$APACHEDIR" -D "xLOGDIR=$LOGDIR" -D "xPORT=$SITE_PORT" -D "xTIMEZONE=$TIMEZONE" -d "xCCSID=$CCSID" -d "xCHROOTPREFIX=$CHROOT_PREFIX" "$1" > "$2"
}
